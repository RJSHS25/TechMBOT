...
with col1:
    st.page_link("pages/1_📦_Material_Master.py", label="📦 Open Material Master")
    st.page_link("pages/2_🚚_Supplier_Onboarding.py", label="🚚 Open Supplier Onboarding")

with col2:
    st.page_link("pages/3_📄_PO_Invoice_Search.py", label="📄 Open PO / Invoice Search")
